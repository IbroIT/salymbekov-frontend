  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{ backgroundImage: `url('https://salymbekov.com/wp-content/uploads/2022/07/bc0b2487.jpg')` }}
      >
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white text-center">
            {t('multimediaDevelopment.title')}
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              {t('multimediaDevelopment.specialist.title')}
            </h2>
            <div className="prose max-w-none text-gray-700">
              {formatTextWithBold(t('multimediaDevelopment.specialist.content'))}
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              {t('multimediaDevelopment.overview.title')}
            </h2>
            <div className="prose max-w-none text-gray-700">
              {formatTextWithBold(t('multimediaDevelopment.overview.content'))}
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              {t('multimediaDevelopment.programGoal.title')}
            </h2>
            <div className="prose max-w-none text-gray-700">
              {formatTextWithBold(t('multimediaDevelopment.programGoal.content'))}
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              {t('multimediaDevelopment.careerOpportunities.title')}
            </h2>
            <div className="prose max-w-none text-gray-700">
              {formatTextWithBold(t('multimediaDevelopment.careerOpportunities.content'))}
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              {t('multimediaDevelopment.otherPrograms.title')}
            </h2>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {t('multimediaDevelopment.otherPrograms.button1')}
              </button>
              <button 
                onClick={() => navigate('/education/itCollege/specialties/diplom-multi-applications')}
              ...
              >
                {t('multimediaDevelopment.otherPrograms.button2')}
              </button>
            </div>
          </div>
        </div>
