  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{ backgroundImage: `url('https://salymbekov.com/wp-content/uploads/2022/07/bc0b2736.jpg')` }}
      >
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {t('softwareDevelopment.otherPrograms.button1')}
              </button>
              <button 
              ...
              >
                {t('softwareDevelopment.otherPrograms.button2')}
              </button>
            </div>
          </div>
        </div>
