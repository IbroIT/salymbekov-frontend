      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
            {t('qualityCouncil.generalProvisions')}
          </h2>
          ...
          {/* Goals and Tasks */}
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
            {t('qualityCouncil.goalsAndTasks')}
          </h2>
          ...
          <div className="prose prose-lg max-w-none text-gray-800 mb-8">
            <ul className="list-disc pl-6 space-y-2 text-lg leading-relaxed">
              <li>{t('qualityCouncil.task1')}</li>
              <li>{t('qualityCouncil.task2')}</li>
              <li>{t('qualityCouncil.task3')}</li>
              <li>{t('qualityCouncil.task4')}</li>
              <li>{t('qualityCouncil.task5')}</li>
              <li>{t('qualityCouncil.task6')}</li>
              <li>{t('qualityCouncil.task7')}</li>
            </ul>
          </div>
